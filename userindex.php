...
<button><a href="?logout">Logout</a></button>
						...
						<li class="text-center text-white">
								...
								<i class="fas fa-sign-out-alt mr-2"></i><div class="user-name">
                                                <?php
												if(isset($_SESSION['name'])):

                                                    //  $count=1;
                                                    //  $sel_query="SELECT * from tbl_registration where name='".$dbusername."'";
			...
			<div class="row header-bot_inner_wthreeinfo_header_mid">
				...
				<div class="col-md-9 header mt-4 mb-md-0 mb-4">
					<div class="row">
						...
						<button><a href="../login/fullcartview.php">view cart</a></button>
					...
					<div class="join-agile text-left p-4">
						<div class="row">
							<div class="col-sm-7 offer-name">
								...
								<h4 class="mt-2 mb-3"><a href="laptop.php" class="button">Laptops</a></h4>
								
							</div>
							<div class="col-sm-5 offerimg-w3l">
								<img src="../main page/images/l1.png" alt="" class="img-fluid">
							</div>
					...
					<div class="join-agile text-left p-4">
						<div class="row ">
							<div class="col-sm-7 offer-name">
								...
								<h4 class="mt-2 mb-3"><a href="product.php" class="button">Smart Phones</a></h4>
								
							</div>
							<div class="col-sm-5 offerimg-w3l">
								<img src="../main page/images/p1.png" alt="" class="img-fluid">
							</div>
						</div>
					</div>
				</div>
