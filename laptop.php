...
?>
						...
						<!-- //search -->
						<!-- cart details -->
						<!-- <button><a href="../login/vcart2.php?pid=<php echo $row['pid']?>"><b><i>MY CART</i></b></a></button> -->

						<button><a href="../login/vcart2.php">view cart</a></button>
						<!-- //cart details -->
					</div>
				</div>
			</div>
								...
								<div class="col-md-4 product-men">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="single.html"><?php echo $row["lname"]; ?>
                                       <?php echo $row["lcolour"]; ?></a>
									   <!-- <a href="../login/cart.php?pid=<php echo $row['pid']?>">ADD TO CART</a> -->
											</h4>
											<div class="info-product-price my-2">
												<span class="item_price"><?php echo $row["lprice"]; ?></span>
												<del>$280.00</del>
											</div>
												...
												<form action="#" method="post">
													<fieldset>
														...
														<button class="button btn">
															...
															<a href="../login/laptop_cart.php?lid=<?php echo $row['lid']?>">ADD TO CART</a>  </button>
