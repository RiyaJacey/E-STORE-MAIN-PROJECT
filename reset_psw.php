...
//  }
    ...
    if(isset($_POST["reset"])){
        ...
        $sql =  mysqli_query($conn, "UPDATE tbl_login SET pass='$psw' WHERE email='$email' AND reset_code='$token'");
        if($sql){
            echo "<script>alert('your password has been succesful reset');window.location.replace('signin11.php');</script>";
