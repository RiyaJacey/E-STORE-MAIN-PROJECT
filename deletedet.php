...
<body>
    <nav class="navbar header-nav navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="admin.php">Vendor Panel</a>
    ...
    <h1>Vendor Panel Product Details</h1>
    ...
    <div class="mycontainer">
        ...
        <div class="table-responsive">
              <table class="table table-bordered table-hover table-striped">
               ...
               <?php
                    if($row1['status']==1){
                        echo '<p><a href="inactive.php?id='.$row1['pid'].'$status=1">Enable</a></p>';
                    }
                    else{
                        echo '<p><a href="active.php?id='.$row1['pid'].'$status=0">Disable</a></p>';
                    }
                    ?></td>
                    <td>
                        <a href="productedit.php?pid=<?php echo $row1['pid']?>">EDIT</a></td>
                     </tr>";  <?php
                                         $cnt++; }       
                                    }
                                }
