        ...
        if(mysqli_num_rows($rs) <= 0){
            ...
            ?>
               <script>
                   ...
                   window.location.replace("signin11.php");
               </script>
           <?php
        }else{
            ...
            $token_sql= "UPDATE tbl_login SET reset_code='$token' WHERE email='$email'";
            //session_start ();
            ...
            if(mysqli_query($conn, $token_sql)){
                ...
                $mail->setFrom('riyajaceykurian2023b@mca.ajce.in', 'Password Reset');
                ...
                http://localhost/estore1/login/reset_psw.php?email=$email&token=$token
                <br><br>
                <p>With regrads,</p>
                <b>e-store</b>";
