...
<button class="large-btn" ><a href="?logout">Logout</a></button> </li>
    ...
    <div class="sidebar-menu">
		    ...
		    <div class="menu">
		      <ul id="menu" >
		          ...
		          <li><a href="#"><i class="fa fa-map-marker"></i><span>HOME</span></a></li>
				  <li><a href="stock.php"><i class="fa fa-map-marker"></i><span>STOCK</span></a></li>
				  <!-- <li><a href="#"><i class="fa fa-map-marker"></i><span>CHANGE PASSWORD</span></a></li> -->
